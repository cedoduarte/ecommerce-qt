...
/** QNetworkRequest with all the content-type available */
...
public:
    ...
    /** sets the default content-type for all the objects of this class */
    static void setDefaultContentType(HeaderMimeType mimeType);

    /** gets the SSL library build version */
    static QString sslLibraryBuildVersionString();
private:
    /** sets the SSL configuration */
    void setSslConfig();

    HeaderMimeType m_mimeType; //!< mime-type
    static HeaderMimeType s_defaultContentType; //!< default content-type
};
